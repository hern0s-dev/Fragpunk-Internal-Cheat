...
void ImGui::Scrollbar(ImGuiAxis axis)
{
    ...
    ScrollbarEx(bb, id, axis, &scroll, (ImS64)size_visible, (ImS64)size_contents, ImDrawFlags_RoundCornersAll);
...
bool ImGui::SliderBehaviorT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, TYPE* v, const TYPE v_min, const TYPE v_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb)
{
    ...
    float slider_usable_pos_min(0.f);
    float slider_usable_pos_max(0.f);
    if (axis == ImGuiAxis_X)
    {
          slider_usable_pos_min = bb.Min[axis] + 10.f;
          slider_usable_pos_max = bb.Max[axis];
    }
    else
    {
          slider_usable_pos_min = bb.Min[axis] + grab_padding + grab_sz * 0.5f;
          slider_usable_pos_max = bb.Max[axis] - grab_padding - grab_sz * 0.5f;
    }
